...
export function AppSidebar() {
  ...
  return (
    <Sidebar className={`${collapsed ? "w-16" : "w-80"} border-r border-border/20 bg-gray-950`}>
          ...
          <>
            ...
            <div className="relative">
              ...
              <Input
                ...
                className="pl-10 bg-gray-900 border-gray-700 focus:border-blue-500 text-white placeholder:text-gray-400"
              />
              {searchQuery && (
                <Button
                  variant="ghost"
                  ...
                  className="absolute right-2 top-1/2 transform -translate-y-1/2 h-6 w-6 p-0 hover:bg-gray-800 text-gray-400 hover:text-white"
                >
                  <X className="w-3 h-3" />
                </Button>
              )}
        ...
        {collapsed && (
          <div className="flex flex-col items-center space-y-2">
            <Button
              ...
              size="sm"
              onClick={handleNewConversation}
              className="w-8 h-8 p-0 text-white hover:bg-gray-800"
            >
              <Plus className="w-4 h-4" />
            </Button>
            <Button
      ...
      <SidebarContent>
        <SidebarGroup>
          {!collapsed && (
            <SidebarGroupLabel className="text-xs text-gray-400 px-4 py-2">
                ...
                {filteredConversations.map((conversation) => (
                  <SidebarMenuItem key={conversation.id}>
                    <SidebarMenuButton 
                      ...
                      className={`w-full h-auto p-3 hover:bg-gray-800 group ${collapsed ? 'justify-center' : 'justify-start'}`}
                    >
                      {collapsed ? (
                        ...
                        <div className="flex items-start space-x-3 w-full">
                          <div className="flex-shrink-0 w-8 h-8 bg-blue-900/50 rounded-lg flex items-center justify-center mt-1">
                            {getCategoryIcon(conversation.category)}
                          </div>
                              ...
                              <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                  <Button
                                    variant="ghost"
                                    size="sm"
                                  className="h-6 w-6 p-0 opacity-0 group-hover:opacity-100 text-gray-400 hover:text-white hover:bg-gray-700"
                                >
          ...
          <div className="space-y-2">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button
                  variant="ghost"
                  className="w-full justify-start h-auto p-3 hover:bg-gray-800 group"
                >
